 ...
 *
 * Deux details qui ne sont pas du confort. Les boutons moins et plus ne sont
 * pas une commodite : WCAG 2.2 demande une alternative au glissement pour qui
 * manie un pointeur sans pouvoir trainer. Et le prix est annonce comme un
 * statut complet — « 200 minutes, 89 € par mois » — plutot que comme un nombre
 * nu, qu'un lecteur d'ecran enoncerait sans dire de quoi il parle.
 */
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <Slider
          ...
          getAriaLabel={() => "Minutes incluses dans l'abonnement"}
